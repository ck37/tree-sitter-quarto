---
title: "Large Benchmark Document - Comprehensive Analysis"
subtitle: "Performance Testing for tree-sitter-quarto"
author:
  - name: "Test Suite"
    affiliation: "tree-sitter-quarto project"
date: 2025-10-17
format:
  html:
    code-fold: true
...
The model achieved an R² score of `{python} model.score(data[['x']], data['y']):.3f`.
