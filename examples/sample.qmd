...
Quarto provides powerful shortcodes for embedding content:
...
Embed specific figures from notebooks:
...
This div has custom attributes that tree-sitter-quarto should parse.
:::
...
5. ✅ Shortcodes ({{< video >}}, {{< include >}}, {{< embed >}})
6. ✅ Callouts with different types
7. ✅ Tabsets and conditional content
8. ✅ Citations (@author)
9. ✅ Divs with attributes
10. ✅ Raw blocks for HTML/LaTeX
11. ✅ Multi-line chunk options
